...
class AimaBicycle implements Bicycle {
    ...
    public AimaBicycle() {
        ...
        JLabel l1 = new JLabel(new ImageIcon("src/main/resources/AIMABicycle.jpg"));
        p1.add(l1);
...
class YadeaBicycle implements Bicycle {
    ...
    public YadeaBicycle() {
        ...
        JLabel l1 = new JLabel(new ImageIcon("src/main/resources/YadeaBicycle.jpg"));
        p1.add(l1);
        Container contentPane = jf.getContentPane();
        sp = new JScrollPane(p1);
        contentPane.add(sp, BorderLayout.CENTER);
